...
from ft import CMD_HANDLER, CMD_LIST, DEFAULT, DEVS, MAN2, MAN3, MAN4, MAN5, bot
        ...
        async def wrapper(check):
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    text = "**✘ MAN-FT ERROR REPORT ✘**\n\n"
                    link = "[Group Support](https://t.me/HadesxGroup)"
                    ...
                    ftext += "\ncukup forward saja pesan ini ke @iHadesx"
                    ftext += "\n================================\n\n"
