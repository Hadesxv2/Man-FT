...
# you may not use this file except in compliance with the License. ft
#
...
# Telegram App KEY and HASH userbot
...
# Default .alive logo
ALIVE_LOGO = (
    os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/d4d806a6f823f082f343d.png"
)

INLINE_PIC = (
    os.environ.get("INLINE_PIC") or "https://telegra.ph/file/d4d806a6f823f082f343d.png"
)
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**Man-FT v{BOT_VER} is back up and running!**\n\n"
...
try:
    from ft.modules.sql_helper.globals import delgvar, gvarstatus
...
with bot:
    try:
        from ft.modules.button import BTN_URL_REGEX, build_keyboard
        from ft.modules.sql_helper.bot_blacklists import check_is_black_list
        from ft.modules.sql_helper.bot_pms_sql import add_user_to_db, get_user_id
        from ft.utils import reply_id
